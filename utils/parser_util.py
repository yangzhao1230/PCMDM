...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='babel', choices=['humanml', 'kit', 'humanact12', 'uestc', 'babel'], type=str,
                       help="Dataset name (choose from list).")
    group.add_argument("--data_dir", default="", type=str,
                       help="If empty, will use defaults according to the specified dataset.")
    group.add_argument("--tiny", default=False, type=bool,
                       help="If True, use only part of data")                   
